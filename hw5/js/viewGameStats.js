...
if(!gameObject.removed) {
    ...
    document.querySelector('#btnSpace').innerHTML = `<a href="editGameStats.html"><button type="button" class="btn">Edit</button></a>`;
} else {
    document.querySelector('#statList').innerHTML = `<div class="top-space"><strong>There are no games to Manage. Add a game from the Game tab.</strong></div>`;
}